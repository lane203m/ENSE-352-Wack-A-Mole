...
;;;;;;;;;;;;;;;;;;;;;;;;;Whack-A-Mole Game;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;		
;This is my whack-a-mole submission for our ENSE 352 project.
;
;Author:  Mason Lane
;Sid:	  200376573
;Date:    05/12/2020
...
WINNINGSIGNALTIME	 EQU 0x0000FFFF		;Main WinningSignalTime for random numbers
;The winning/losing signal times below comprise of the values needed to display LEDs for ~1min
WINNINGSIGNALTIMEA   EQU 0x89			;Multiplier. 
WINNINGSIGNALTIMEB 	 EQU 0x40000		;First half of loop
WINNINGSIGNALTIMEC 	 EQU 0x20000		;Second half of loop

LOSINGSIGNALTIMEZERO EQU 0x12			;Multiplier for scores of zero
LOSINGSIGNALTIMEA 	 EQU 0x3D			;Multiplier 
...
flash
	...
	PUSH {R6}
	LDR R6, = WINNINGSIGNALTIME
wait						;Loop for WINNINGSIGNALTIME
	BL counter
	CMP R6, #0
	BNE wait
again
